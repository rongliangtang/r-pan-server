package com.tangrl.pan.cache.caffeine.test.instance;
...
public class CacheAnnotationTester {
    ...
    public String testCacheable(String name) {
        log.info("call com.tangrl.pan.cache.caffeine.test.instance.CacheAnnotationTester.testCacheable, param is {}", name);
