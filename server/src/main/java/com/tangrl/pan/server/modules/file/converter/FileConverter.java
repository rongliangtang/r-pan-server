...
import com.tangrl.pan.server.modules.file.po.*;
...
public interface FileConverter {
    ...
    @Mapping(target = "parentId", expression = "java(com.tangrl.pan.core.utils.IdUtil.decrypt(createFolderPO.getParentId()))")
    ...
    @Mapping(target = "fileId", expression = "java(com.tangrl.pan.core.utils.IdUtil.decrypt(updateFilenamePO.getFileId()))")
    @Mapping(target = "userId", expression = "java(com.tangrl.pan.server.common.utils.UserIdUtil.get())")
    ...
    @Mapping(target = "parentId", expression = "java(com.tangrl.pan.core.utils.IdUtil.decrypt(secUploadFilePO.getParentId()))")
    @Mapping(target = "userId", expression = "java(com.tangrl.pan.server.common.utils.UserIdUtil.get())")
    SecUploadFileContext secUploadFilePO2SecUploadFileContext(SecUploadFilePO secUploadFilePO);

    @Mapping(target = "parentId", expression = "java(com.tangrl.pan.core.utils.IdUtil.decrypt(fileUploadPO.getParentId()))")
    @Mapping(target = "userId", expression = "java(com.tangrl.pan.server.common.utils.UserIdUtil.get())")
    ...
    @Mapping(target = "userId", expression = "java(com.tangrl.pan.server.common.utils.UserIdUtil.get())")
    @Mapping(target = "parentId", expression = "java(com.tangrl.pan.core.utils.IdUtil.decrypt(fileChunkMergePO.getParentId()))")
