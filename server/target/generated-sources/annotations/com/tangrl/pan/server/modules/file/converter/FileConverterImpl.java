package com.tangrl.pan.server.modules.file.converter;
...
import com.tangrl.pan.server.modules.file.context.FileChunkMergeContext;
import com.tangrl.pan.server.modules.file.context.FileChunkSaveContext;
import com.tangrl.pan.server.modules.file.context.FileChunkUploadContext;
import com.tangrl.pan.server.modules.file.context.FileSaveContext;
import com.tangrl.pan.server.modules.file.context.FileUploadContext;
import com.tangrl.pan.server.modules.file.context.QueryUploadedChunksContext;
import com.tangrl.pan.server.modules.file.context.SecUploadFileContext;
import com.tangrl.pan.server.modules.file.context.UpdateFilenameContext;
import com.tangrl.pan.server.modules.file.entity.RPanUserFile;
import com.tangrl.pan.server.modules.file.po.CreateFolderPO;
import com.tangrl.pan.server.modules.file.po.DeleteFilePO;
import com.tangrl.pan.server.modules.file.po.FileChunkMergePO;
import com.tangrl.pan.server.modules.file.po.FileChunkUploadPO;
import com.tangrl.pan.server.modules.file.po.FileUploadPO;
import com.tangrl.pan.server.modules.file.po.QueryUploadedChunksPO;
import com.tangrl.pan.server.modules.file.po.SecUploadFilePO;
import com.tangrl.pan.server.modules.file.po.UpdateFilenamePO;
import com.tangrl.pan.server.modules.file.vo.FolderTreeNodeVO;
...
public class FileConverterImpl implements FileConverter {
    ...
    public CreateFolderContext createFolderPO2CreateFolderContext(CreateFolderPO createFolderPO) {
        ...
        createFolderContext.setParentId( com.tangrl.pan.core.utils.IdUtil.decrypt(createFolderPO.getParentId()) );
        createFolderContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public UpdateFilenameContext updateFilenamePO2UpdateFilenameContext(UpdateFilenamePO updateFilenamePO) {
        ...
        updateFilenameContext.setFileId( com.tangrl.pan.core.utils.IdUtil.decrypt(updateFilenamePO.getFileId()) );
        updateFilenameContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public DeleteFileContext deleteFilePO2DeleteFileContext(DeleteFilePO deleteFilePO) {
        ...
        deleteFileContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public SecUploadFileContext secUploadFilePO2SecUploadFileContext(SecUploadFilePO secUploadFilePO) {
        ...
        secUploadFileContext.setParentId( com.tangrl.pan.core.utils.IdUtil.decrypt(secUploadFilePO.getParentId()) );
        secUploadFileContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileUploadContext fileUploadPO2FileUploadContext(FileUploadPO fileUploadPO) {
        ...
        fileUploadContext.setParentId( com.tangrl.pan.core.utils.IdUtil.decrypt(fileUploadPO.getParentId()) );
        fileUploadContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileChunkUploadContext fileChunkUploadPO2FileChunkUploadContext(FileChunkUploadPO fileChunkUploadPO) {
        ...
        fileChunkUploadContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public QueryUploadedChunksContext queryUploadedChunksPO2QueryUploadedChunksContext(QueryUploadedChunksPO queryUploadedChunksPO) {
        ...
        queryUploadedChunksContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileChunkMergeContext fileChunkMergePO2FileChunkMergeContext(FileChunkMergePO fileChunkMergePO) {
        ...
        fileChunkMergeContext.setUserId( com.tangrl.pan.server.common.utils.UserIdUtil.get() );
        fileChunkMergeContext.setParentId( com.tangrl.pan.core.utils.IdUtil.decrypt(fileChunkMergePO.getParentId()) );
